...
namespace Tahi
{
    public partial class WallX : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (Session["UserID"] != null && Session["CompID"] != null)
            {
                ...
                foreach (var ppp in DB.ELTahiPerantPosts.OrderByDescending(l => l.ElTahiPostRegDT).ToList())
                {
                    ...
                    else if (ppp.ELTahiPostType == 3 || ppp.ELTahiPostType == 4 || ppp.ELTahiPostType == 6 || ppp.ELTahiPostType == 7 || ppp.ELTahiPostType == 8)
                    {
