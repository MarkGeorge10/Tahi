<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AddStatus.aspx.cs" Inherits="Tahi.AddStatus" %>
                        ...
                        <div class="row no-gutters">
                            <div class="col-lg-12">
                                <div class="signup-form-wrapper" style="padding-top: 50px;">
                                    <h1 class="create-acc text-center">Add New Status</h1>
                                    <div class="signup-inner text-center" style="max-width: 100%;">
                                        ...
                                        <div class="signup-inner--form" >
                                            <div class="row">
                                                <div class="col-12">
                                                    <asp:TextBox ID="txtstatus" placeholder="Add status" class="single-field" runat="server"></asp:TextBox>
                                                </div>
                                                <div class="col-md-6">
