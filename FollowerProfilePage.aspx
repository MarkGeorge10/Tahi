<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FollowerProfilePage.aspx.cs" Inherits="Tahi.FollowerProfilePage" %>
                ...
                <div class="row align-items-center">
                    <div class="col-md-5">
                        ...
                        <div class="header-top-navigation">
                            <nav>
                                <ul>
                                    <li class="active"><a href="wall.aspx">home</a></li>
                                ...
                                <div class="profile-thumb-small">
                                    ...
                                    <div class="profile-dropdown">
                                        ...
                                        <div class="profile-body">
                                            <ul>
                                                <li><a href="profile.aspx"><i class="flaticon-user"></i>Profile</a></li>
                                             
                                            </ul>
                                            <ul>
                                               
                                                <li><a href="index.aspx"><i class="flaticon-unlock"></i>Sign out</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="main-wrapper">
            ...
            <div class="profile-menu-area secondary-navigation-style bg-white">
                <div class="container">
                    <div class="row align-items-center">
                        <%-- profile Picture --%>
                        <div class="col-lg-3 col-md-3" style="border: 1px solid #DDDDDD;  position: relative;">

                           
                            
                            <div id="followDiv" runat="server" class="profile-picturebtn" style="z-index: 2;background-color: #92AD40;color: #FFFFFF;font-weight: bold;">
                                <asp:Button ID="followBtn" runat="server" Text="Follow"  style="z-index: 2; border: none; background-color: #92AD40;color: #FFFFFF;font-weight: bold;" OnClick="followClick" />
                            </div>

                            <div id="unFollowDiv" runat="server" class="profile-picturebtn" style="z-index: 2;background-color: #92AD40;color: #FFFFFF;font-weight: bold;">
                                 <asp:Button ID="unFollowBtn"  runat="server" Text="Followed"  style="z-index: 2; border: none; background-color: #92AD40;color: #FFFFFF;font-weight: bold;" OnClick="unFollowClick"/>
                           ...
                           <div class="profile-picture-box" runat="server" id="proimge" >
                           </div>
         <%-- </div>--%>
                        ...
                        <div class="col-lg-6 col-md-6 offset-lg-1">
                            <div class="profile-menu-wrapper">
                                <div class="main-menu-inner header-top-navigation">
                                    <nav>
                                        <ul class="main-menu">
                                            <%--<li><a href="wall.aspx">timeline</a></li>--%>
                                            <li><a href="profile.aspx">Profile</a></li>
                                            <li><a href="FriendsPage.aspx">Follower</a></li>
                                            <li><a href="Restaurant.aspx">Restaurant</a></li>
                                            <li><a href="about.html">Supplier</a></li>
